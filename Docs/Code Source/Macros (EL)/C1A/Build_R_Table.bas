...
Sheets("R_Table").Move Before:=Sheets("CAN Message Set")
...
For pointeur1 = 2 To VRange_param.Rows.Count
    ...
    For pointeur2 = 9 To VRange_param.Columns.Count
        ...
        If (Worksheets("Param").Cells(pointeur1, pointeur2).Value = "R") Then
            ...
            Worksheets("R_Table").Cells(increment, 70).Value = pointeur1
            'increlentation de l'index
