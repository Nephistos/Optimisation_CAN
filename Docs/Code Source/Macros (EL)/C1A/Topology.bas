...
Dim VRange_topology, VRange_topology2, VRange_connection, VRange_frame_synthese As Range
...
For pointeur4 = 1 To VRange_topology2.Rows.Count
    ...
    For pointeur5 = 8 To VRange_frame_synthese.Columns.Count
        ...
        If (ThisWorkbook.Worksheets("Topology").Cells(pointeur4, 1).Value = ThisWorkbook.Worksheets("Frame synthesis").Cells(5, pointeur5).Value) Then
        ...
        ElseIf ((is_ok = False) And (pointeur5 = VRange_frame_synthese.Columns.Count)) Then
            ...
            ThisWorkbook.Worksheets("Topology").Cells(pointeur4, 1).Interior.Color = RGB(254, 0, 0)
            is_ok = True
        End If
    Next pointeur5
    
    If (ThisWorkbook.Worksheets("Topology").Cells(pointeur4, 1).Interior.Color = RGB(254, 0, 0)) Then
