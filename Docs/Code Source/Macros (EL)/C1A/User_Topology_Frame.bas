Attribute VB_Name = "User_Topology_Frame"
Option Explicit
...
Dim VRange_user_topology, VRange_user_topology2, VRange_connection, VRange_frame As Range
...
For pointeur4 = 2 To VRange_user_topology.Rows.Count
    ...
    For pointeur5 = 6 To VRange_frame.Columns.Count
        ...
        If (ThisWorkbook.Worksheets("User Topology").Cells(pointeur4, 1).Value = ThisWorkbook.Worksheets("Frame").Cells(1, pointeur5).Value) Then
        ...
        ElseIf ((is_ok = False) And (pointeur5 = VRange_frame.Columns.Count)) Then
            ...
            'ThisWorkbook.Worksheets("User Topology").Cells(pointeur4, 1).Interior.Color = RGB(255, 0, 0)
            ThisWorkbook.Worksheets("User Topology").Cells(pointeur4, 1).Interior.Color = RGB(255, 0, 0)
            is_ok = True
        End If
    Next pointeur5
    
    If (ThisWorkbook.Worksheets("User Topology").Cells(pointeur4, 1).Interior.Color = RGB(255, 0, 0)) Then
...
Range(Cells(2, 2), Cells(VRange_user_topology2.Rows.Count, VRange_user_topology2.Columns.Count)) = "0"
