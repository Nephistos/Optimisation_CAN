...
For pointeur2 = 25 To VRange_can_set_message.Columns.Count
    ...
    For pointeur1 = 2 To VRange_can_set_message.Rows.Count
        ...
        ElseIf (VRange_can_set_message2(pointeur1, pointeur2) = "T,R") Then
            VRange_can_set_message2(pointeur1, pointeur2) = ""
        ElseIf (VRange_can_set_message2(pointeur1, pointeur2) = "R,T") Then
            VRange_can_set_message2(pointeur1, pointeur2) = ""
        End If
        ...
        If (VRange_can_set_message2(pointeur1, pointeur2) <> "") Then
            ...
            For pointeur3 = 2 To VRange_isr_synthese.Rows.Count
                ...
                If ((UCase(VRange_can_set_message2(pointeur1, 1)) = UCase(VRange_isr_synthese2(pointeur3, 10))) And (UCase(VRange_can_set_message2(1, pointeur2)) = UCase(VRange_isr_synthese2(pointeur3, 39)))) Then 'And (Worksheets("ISR_Synthese").Cells(pointeur3, 40).Value <> "")) Then
...
For pointeur5 = 25 To VRange_can_set_message.Columns.Count
    For pointeur6 = 2 To VRange_can_set_message.Rows.Count
        ThisWorkbook.Worksheets("Message List (FD+HS) all CAN").Cells(pointeur6, pointeur5).Value = VRange_can_set_message2(pointeur6, pointeur5)
    Next pointeur6
Next pointeur5
