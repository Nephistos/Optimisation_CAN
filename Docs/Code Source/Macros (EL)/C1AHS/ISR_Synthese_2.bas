...
ThisWorkbook.Worksheets("C1A_HS HS applied proposal").Activate
ActiveSheet.Cells(1, 1).Activate
...
For pointeur1 = 2 To VRange_isr_synthese.Rows.Count
    ...
    For pointeur2 = 2 To VRange_isr_applied.Rows.Count
        ...
        If (CStr(VRange_isr_applied2(pointeur2, 1)) = CStr(VRange_isr_synthese2(pointeur1, 3))) Then
            VRange_isr_synthese2(pointeur1, 39) = VRange_isr_applied2(pointeur2, 4)
            Exit For
        End If
    Next pointeur2
Next pointeur1
...
For pointeur3 = 2 To VRange_isr_synthese.Rows.Count
    ...
    If (VRange_isr_synthese2(pointeur3, 39) = "") Then
        VRange_isr_synthese2(pointeur3, 39) = VRange_isr_synthese2(pointeur3, 8)
    End If
Next pointeur3
